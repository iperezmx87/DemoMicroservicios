namespace Isra.Demos.Microservicios.Modelo
{
    ...
    public static class Constantes
    {
        ...
        /// </summary>
        public const string MongoDbConnectionString = "mongodb://192.168.0.99:27017/bd_cuentas_movimientos?replicaSet=rs0&directConnection=true";
        ...
        /// </summary>
        public const string KafkaBootstrapServers = "kafka:29092";
        ...
        /// </summary>
        public const string PostgresConnectionString = "Host=host.docker.internal;Port=5432;Database=bd_saldos_cuentas;Username=postgres;Password=Saucedo870824";
        ...
        /// </summary>
        public const string SQLServerConnectionString = "Server=host.docker.internal\\SQLEXPRESS;Database=BDESTADOCUENTA;user id=sa;password=Saucedo870824;TrustServerCertificate=True;";
        ...
        /// </summary>
        public const string SqlServerBancoCuentasConnectionString = "Server=host.docker.internal\\SQLEXPRESS;Database=BDBANCOCUENTAS;user id=sa;password=Saucedo870824;TrustServerCertificate=True;";
    }
}
